        ...
        <div class="col-md-5 col-lg-4">
            ...
            <div class="card shadow border-0">
                <div class="card-header bg-primary text-white text-center py-4">
                    <h2 class="mb-0 fw-bold">Ticket Gateway</h2>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form action="${pageContext.request.contextPath}/authenticate" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control form-control-lg" placeholder="Enter your username" required />
                        </div>
                ...
                <div class="card-footer bg-white border-0 text-center pb-4">
                    ...
                    <a href="register.jsp" class="text-primary fw-bold text-decoration-none">Register</a>
                </div>
            </div>
