                ...
                <c:forEach items="${tickets}" var="ticket">
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- REOPEN -->
                            <c:if test="${ticket.status eq 'RESOLVED'}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" onclick="submitCloseTicket()">Close</button>
            </div>
...
<!-- ================= REOPEN MODAL ================= -->
<div class="modal" id="reopenModal" style="background: rgba(0,0,0,0.5);">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <textarea id="reopenReason"
                              class="form-control"
                              rows="3"
                              placeholder="Explain why this ticket is being reopened"></textarea>
                </div>
            </div>

            <div class="modal-footer">
                <button class="btn btn-secondary" onclick="closeReopenModal()">Cancel</button>
                <button class="btn btn-danger" onclick="submitReopen()">Reopen</button>
            </div>
...
function submitCloseTicket() {
    ...
    formData.append("comments", $("#resolutionNotes").val());



    $.ajax({
        url: "${pageContext.request.contextPath}/closeTicket",
        type: "PUT",
        data: formData,
        processData: false,
        contentType: false,
...
function submitReopen() {
	var formData = new FormData();
	formData.append("ticketId",$("#reopenTicketId").val())
	formData.append("comments", $("#reopenReason").val())
    $.ajax({
        url: "${pageContext.request.contextPath}/reopenTicket",
        type: "PUT",
        data: formData,
		processData: false,
		contentType: false,
