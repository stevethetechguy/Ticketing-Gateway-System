...
public class TicketListener {
	...
	@JmsListener(destination = "ticket.pendingFor7Days")
	public void receiveTicketPendingFor7Days(String ticketJson) {
	    Map<String, String> ticketMap = objectMapper.readValue(ticketJson, new TypeReference<Map<String, String>>() {});
	    ...
	    String emailBody = """
	            ...
	            The following ticket has been pending for 7 days.
	    ...
	    //Send Email to manager
	    emailService.sendSimpleEmail(ticketMap.get("managerEmail"), "TICKET PENDING FOR 7 Days: " + ticketId  ,emailBody);
	}
	@JmsListener(destination = "ticket.resolvedFor5Days")
	public void receiveTicketResolvedFor5Days(String ticketJson) {
	    Map<String, String> ticketMap = objectMapper.readValue(ticketJson, new TypeReference<Map<String, String>>() {});
	    ...
	    String emailBody = """
	            ...
	            The following ticket has been resolved for 5 days.
	            ...
	            The system has closed the ticket due to inactivity.
	    ...
	    //Send Email to manager
	    emailService.sendSimpleEmail(ticketMap.get("createdByEmail"), "TICKET CLOSED: " + ticketId  ,emailBody);
	}
